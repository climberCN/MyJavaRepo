...
// >> TODO 来理清一下自己的核心需求：针对手机，限制一次性购买的数量。必须限制死，必须不影响别的商品，必须只能改手机类的代码
// >> TODO 这时候，组合就无能为力了，继承可以发挥其应有的作用。

// >> TODO 继承不是组合，继承也不只是为了简单的拿来父类的属性和方法。如果仅仅如此，原封不动的拿来主义，组合也能做到。
// TODO 继承也不是通过组合的方式来实现的。和组合相比，继承更像是“融合”
// >> TODO 所谓融合，即合二为一，可以互相影响。父类影响子类没问题，子类怎么影响父类呢？如何限制手机一次只能最多买5个？
