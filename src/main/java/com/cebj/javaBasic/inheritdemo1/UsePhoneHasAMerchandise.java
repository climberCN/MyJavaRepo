...
import com.cebj.javaBasic.inheritdemo1.supermarket.MerchandiseV2;
import com.cebj.javaBasic.inheritdemo1.supermarket.PhoneHasAMerchandise;

public class UsePhoneHasAMerchandise {
    public static void main(String[] args) {
        MerchandiseV2 merchandise =
                new MerchandiseV2("手机001", "Phone001", 100, 1999, 999);
        PhoneHasAMerchandise phone = new PhoneHasAMerchandise(
                ...
                merchandise);
        phone.describePhone();
        // TODO 所有和商品相关的操作，我们要先从Phone里获得商品的引用，然后再通过这个引用来操作商品
