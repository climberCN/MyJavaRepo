...
public class RunLittleSupperMarketAppMain {
    public static void main(String[] args) {
        ...
        System.out.println("VIP购买10个" + bigprofit.getName() + "的花费为：" + cost1);

        // >> TODO 使用别的类的静态变量的时候，需要使用完整形态：类名.静态变量的名字
        MerchandiseV2WithStaticVariable.DISCOUNT_FOR_VIP = 0.5;
        bigprofit.describe();

        double cost2 = bigprofit.buy(10, true);
        System.out.println("VIP购买10个" + bigprofit.getName() + "的花费为：" + cost2);
        ...
        System.out.println("VIP购买10个" + bigprofit.getName() + "的花费为：" + cost3);
    }
}
