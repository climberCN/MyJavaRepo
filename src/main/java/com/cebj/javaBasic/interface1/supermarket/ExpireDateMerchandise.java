...
// 接口中的方法，就是这个类型的规范，接口专注于规范，怎么实现这些规范他不管
...
public interface ExpireDateMerchandise {
	 ...
	 * @return 截止到当前，true保质期剩余天数比参数长，false保质期不到这么多天
	 */
	boolean notExpireInDays(int days);

	/**
	 * 因为接口里的方法都是且只能用public abstract修饰，所以这两个修饰符可以省略
	...
	// 接口里不能定义成员变量，定义的变量默认都是public static final的，这三个修饰符平时一样可以省略
